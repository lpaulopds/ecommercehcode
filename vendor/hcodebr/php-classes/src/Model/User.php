<?php
	...
	class User extends Model {
		...
		// Função para alteração de dados do usuário
		// O nome da função: get como descrito no curso, causa erro cannot be declared
		// Após teste a função funciona normalmente com o novo nome: gete
		public function gete($iduser) {
